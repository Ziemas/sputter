...
IOP_OBJS = src/sputter.o src/naxtest.o src/noisetest.o src/playsound.o \
			...
			src/tsatest.o never.o imports.o
IOP_LIBS =
...
TEST_OBJS = ee/loader.o libsd.o sputter.o
TEST_EXE = loader.elf
TEST_LIBS = -ldebug -lpatches
...
all: $(IOP_BIN) $(EE_LIB) $(TEST_EXE) never.adp sine.adp click.adp crash.adp drums.adp
